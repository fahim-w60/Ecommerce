  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-dark">
      ...
      <div class="collapse navbar-collapse" id = "navbarSupportedContent">
        ...
        <button class="btn btn-primary btn-sm" name="">  <a style="color:white; class="nav-link" href="profile.php">My Order </a></button>
				 <a href="user_logout.php"><button style="margin-left:500px"; class="btn btn-outline-info btn-sm" name="">logout</button><a/>
              </li>
...
<td><a href="edit_myprofile.php?edit=<?php echo $temp['id'];?>"><button type="button" class="btn btn-warning" >Edit</button></a></td>
   </tr>
