...
<body style="margin-bottom: 100px;">
        ...
        <div class="collapse navbar-collapse" id = "navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                      ...
                      <button class="btn btn-primary btn-sm" name=""><a style="color:white; class="nav-link" href="myprofile.php"> My Profile </a></button>
                </li>
    ...
    <div class="container">
        ...
        <div  style="margin-top: 10px;margin-left: 10px;width: 18rem; height: 25rem; float: left" class="card">

            <div class="card-header"><?php echo $temp['name']; ?></div>
            <img style="height: 7rem;" src=" img/<?php echo $temp['image']; ?>" class="card-img-top" alt="image" />
            <div class="card-body">
          ...
          <input type="text" name="p_id" value="<?php echo $temp['id'] ?>" hidden>
               ...
               <button style="margin-top: 10px;" type="submit" >Add To Cart</button></a>
				  </div>
				  </form>
            </div>
        </div>
